...
for vogal in texto:
    a = texto.lower().count('a')
    e = texto.lower().count('e')
    i = texto.lower().count('i')
    o = texto.lower().count('o') 
    u = texto.lower().count('u')
    
print(f"Quantidade de vogais A/a {a}")
print(f"Quantidade de vogais E/e {e}")
print(f"Quantidade de vogais I/i {i}")
print(f"Quantidade de vogais O/o {o}")
print(f"Quantidade de vogais U/u {u}")